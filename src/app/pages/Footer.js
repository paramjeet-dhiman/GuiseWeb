export const Footer = () => {
  return (
    <footer className="bg-gray-800 pt-5   overflow-hidden ">
      <div className=" text-gray-800 flex flex-wrap py-10 justify-center  mx-auto max-w-7xl">
        {/* <div className=" p-5 w-64">
          ...
          <p className="mt-5 w-3/4 text-left text-sm text-white">
        ...
        {/* <div className="p-5 w-48 lg:w-2/12">
          ...
          <a
            className="my-3 block text-gray-400 hover:text-gray-100 font-medium duration-500 text-sm  "
            href="/#">
            Analytics <span className="text-social-facebook text-xs p-1"></span>
          </a>
          <a
            className="my-3 block text-gray-400 hover:text-gray-100 font-medium duration-500 text-sm  "
            href="/#">
